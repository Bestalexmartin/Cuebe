...
const NOTE_PRESET_COLORS = [
    { name: 'Default', value: '#E2E8F0' },  // Light gray (default)
    { name: 'Red', value: '#EF4444' },      // Bright red
    { name: 'Grey', value: '#6B7280' },     // Medium gray
    { name: 'Black', value: '#1F2937' },    // Dark gray/black
    { name: 'Blue', value: '#3B82F6' },     // Bright blue
    { name: 'Yellow', value: '#EAB308' },   // Golden yellow
];
```
...
*This documentation covers the note color customization system implementation as of July 2025. For related documentation, see [Drag-and-Drop System](./drag-and-drop-system.md) and [Script Elements Data Model](./script-elements-data-model.md).*